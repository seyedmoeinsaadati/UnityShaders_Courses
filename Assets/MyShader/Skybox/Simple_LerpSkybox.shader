Shader "Moein/Skybox/LerpSkyBox" {
Properties {
    ...
    [KeywordEnum(6 Frames, Latitude Longitude)] _Mapping("Mapping", Float) = 1
...
SubShader {
    ...
    Pass {
        ...
        #pragma target 2.0
        #pragma multi_compile_local __ _MAPPING_6_FRAMES
        ...
        v2f vert (appdata_t v)
        {
            ...
            float sourceAspect = float(_Texture1_TexelSize.z) / float(_Texture1_TexelSize.w);
            ...
            o.edgeSize.xy = _Texture1_TexelSize.xy * 0.5 / o.layout.yz - 0.5;
            o.edgeSize.zw = -o.edgeSize.xy;
#else // !_MAPPING_6_FRAMES

...
SubShader {
    ...
    Pass {
        ...
        v2f vert (appdata_t v)
        {
            ...
            float plasmaValue = abs(plasma(v.uv, t, _PlasmaScale1, _PlasmaScale2, _PlasmaScale3, _PlasmaScale4));
            o.uv += plasmaValue * _PlasmaScale0 * _PlasmaWieght;
        ...
        {            
            half3 col1 = tex2D(_MainTex, i.uv).rgb * _Tint.rgb * unity_ColorSpaceDouble.rgb * _Exposure;
            return half4(col1, 1);
        }
        ENDCG
    }
